...
#define TOL_LU (numx_real_t)1e-4

/* ── numx_vec_dot ──────────────────────────────────────────────────── */

void test_vec_dot_known(void)
{
    numx_real_t a[] = {(numx_real_t)1.0, (numx_real_t)2.0, (numx_real_t)3.0};
    numx_real_t b[] = {(numx_real_t)4.0, (numx_real_t)5.0, (numx_real_t)6.0};
    numx_real_t r;
    TEST_ASSERT_EQUAL(NUMX_OK, numx_vec_dot(a, b, 3, &r));
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)32.0, r);
}

void test_vec_dot_orthogonal(void)
{
    numx_real_t a[] = {(numx_real_t)1.0, (numx_real_t)0.0, (numx_real_t)0.0};
    numx_real_t b[] = {(numx_real_t)0.0, (numx_real_t)1.0, (numx_real_t)0.0};
    numx_real_t r;
    TEST_ASSERT_EQUAL(NUMX_OK, numx_vec_dot(a, b, 3, &r));
...
{
    numx_real_t a[] = {(numx_real_t)3.0, (numx_real_t)4.0};
    numx_real_t r;
    numx_vec_dot(a, a, 2, &r);
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)25.0, r);
}

void test_vec_dot_single_element(void)
{
    numx_real_t a[] = {(numx_real_t)7.0};
    numx_real_t b[] = {(numx_real_t)3.0};
    numx_real_t r;
    TEST_ASSERT_EQUAL(NUMX_OK, numx_vec_dot(a, b, 1, &r));
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)21.0, r);
}

void test_vec_dot_zero_vector(void)
{
    numx_real_t a[] = {(numx_real_t)0.0, (numx_real_t)0.0, (numx_real_t)0.0};
    numx_real_t b[] = {(numx_real_t)1.0, (numx_real_t)2.0, (numx_real_t)3.0};
    numx_real_t r;
    TEST_ASSERT_EQUAL(NUMX_OK, numx_vec_dot(a, b, 3, &r));
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)0.0, r);
}
...
{
    numx_real_t b[] = {(numx_real_t)1.0}, r;
...
{
    numx_real_t a[] = {(numx_real_t)1.0}, b[] = {(numx_real_t)1.0};
    TEST_ASSERT_EQUAL(NUMX_ERR_NULL_PTR, numx_vec_dot(a, b, 1, NULL));
}

void test_vec_dot_zero_n(void)
{
    numx_real_t a[] = {(numx_real_t)1.0}, b[] = {(numx_real_t)1.0}, r;
...
{
    numx_real_t a[] = {(numx_real_t)3.0, -(numx_real_t)4.0, (numx_real_t)0.0};
    numx_real_t r;
...
{
    numx_real_t a[] = {(numx_real_t)3.0, -(numx_real_t)5.0, (numx_real_t)4.0};
    numx_real_t r;
...
void test_vec_cross3_x_cross_y(void)
{
    ...
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)0.0, r[0]);
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)0.0, r[1]);
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)1.0, r[2]);
}
...
{
    numx_real_t a[] = {(numx_real_t)2.0, (numx_real_t)0.0, (numx_real_t)0.0};
    numx_real_t b[] = {(numx_real_t)5.0, (numx_real_t)0.0, (numx_real_t)0.0};
    numx_real_t r[3];
    numx_vec_cross3(a, b, r);
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)0.0, r[0]);
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)0.0, r[1]);
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)0.0, r[2]);
}
...
void test_vec_cross3_alias_safe(void)
{
    ...
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)0.0, a[0]);
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)0.0, a[1]);
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)1.0, a[2]);
}

void test_vec_cross3_null(void)
{
    numx_real_t b[] = {(numx_real_t)1.0, (numx_real_t)0.0, (numx_real_t)0.0}, r[3];
...
{
    numx_real_t A[] = {(numx_real_t)1.0, (numx_real_t)2.0, (numx_real_t)3.0, (numx_real_t)4.0};
    numx_real_t B[] = {(numx_real_t)5.0, (numx_real_t)6.0, (numx_real_t)7.0, (numx_real_t)8.0};
    numx_real_t C[4];
    TEST_ASSERT_EQUAL(NUMX_OK, numx_mat_mul(A, 2, 2, B, 2, 2, C));
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)19.0, C[0]);
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)22.0, C[1]);
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)43.0, C[2]);
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)50.0, C[3]);
}

void test_mat_mul_2x3_times_3x2(void)
{
    numx_real_t A[] = {(numx_real_t)1.0, (numx_real_t)2.0, (numx_real_t)3.0, (numx_real_t)4.0, (numx_real_t)5.0, (numx_real_t)6.0};
    numx_real_t B[] = {(numx_real_t)7.0, (numx_real_t)8.0, (numx_real_t)9.0, (numx_real_t)10.0, (numx_real_t)11.0, (numx_real_t)12.0};
    numx_real_t C[4];
    TEST_ASSERT_EQUAL(NUMX_OK, numx_mat_mul(A, 2, 3, B, 3, 2, C));
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)58.0,  C[0]);
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)64.0,  C[1]);
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)139.0, C[2]);
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)154.0, C[3]);
}

void test_mat_mul_identity(void)
{
    numx_real_t A[] = {(numx_real_t)1.0, (numx_real_t)2.0, (numx_real_t)3.0, (numx_real_t)4.0};
    numx_real_t I[] = {(numx_real_t)1.0, (numx_real_t)0.0, (numx_real_t)0.0, (numx_real_t)1.0};
    numx_real_t C[4];
...
void test_mat_transpose_2x3(void)
{
    ...
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)1.0, AT[0]);
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)4.0, AT[1]);
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)2.0, AT[2]);
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)5.0, AT[3]);
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)3.0, AT[4]);
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)6.0, AT[5]);
}
...
void test_mat_transpose_sq_inplace(void)
{
    ...
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)1.0, A[0]);
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)3.0, A[1]);
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)2.0, A[2]);
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)4.0, A[3]);
}

void test_mat_transpose_sq_twice_is_identity(void)
{
    numx_real_t A[] = {(numx_real_t)1.0,(numx_real_t)2.0,(numx_real_t)3.0,(numx_real_t)4.0,(numx_real_t)5.0,(numx_real_t)6.0,(numx_real_t)7.0,(numx_real_t)8.0,(numx_real_t)9.0};
    numx_real_t orig[9];
    numx_size_t i;
...
{
    numx_real_t A[] = {(numx_real_t)1.0,(numx_real_t)2.0,(numx_real_t)3.0,(numx_real_t)4.0,(numx_real_t)5.0,(numx_real_t)6.0,(numx_real_t)7.0,(numx_real_t)8.0,(numx_real_t)10.0};
    numx_real_t r;
...
{
    numx_real_t I[] = {(numx_real_t)1.0,(numx_real_t)0.0,(numx_real_t)0.0,(numx_real_t)0.0,(numx_real_t)1.0,(numx_real_t)0.0,(numx_real_t)0.0,(numx_real_t)0.0,(numx_real_t)1.0};
    numx_real_t r;
    numx_mat_det(I, 3, &r);
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)1.0, r);
}
...
{
    numx_real_t A[] = {(numx_real_t)1.0, (numx_real_t)2.0, (numx_real_t)2.0, (numx_real_t)4.0};
    numx_real_t r;
    TEST_ASSERT_EQUAL(NUMX_OK, numx_mat_det(A, 2, &r));
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)0.0, r);
}
...
{
    numx_real_t A[] = {(numx_real_t)1.0, (numx_real_t)0.0, (numx_real_t)0.0, (numx_real_t)1.0};
...
{
    numx_real_t A[] = { (numx_real_t)2.0, (numx_real_t)1.0,-(numx_real_t)1.0,
                       -(numx_real_t)3.0,-(numx_real_t)1.0, (numx_real_t)2.0,
                       -(numx_real_t)2.0, (numx_real_t)1.0, (numx_real_t)2.0};
    numx_real_t b[] = {(numx_real_t)8.0,-(numx_real_t)11.0,-(numx_real_t)3.0};
    ...
    TEST_ASSERT_FLOAT_WITHIN(TOL_LU,  (numx_real_t)2.0, x[0]);
    TEST_ASSERT_FLOAT_WITHIN(TOL_LU,  (numx_real_t)3.0, x[1]);
    TEST_ASSERT_FLOAT_WITHIN(TOL_LU, -(numx_real_t)1.0, x[2]);
}

void test_lu_solve_identity_system(void)
{
    numx_real_t A[] = {(numx_real_t)1.0,(numx_real_t)0.0,(numx_real_t)0.0,(numx_real_t)1.0};
    numx_real_t b[] = {(numx_real_t)5.0,(numx_real_t)7.0};
    numx_real_t LU[4]; numx_idx_t pivot[2]; numx_real_t x[2];
    numx_lu_decompose(A, 2, LU, pivot);
    numx_lu_solve(LU, pivot, 2, b, x);
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)5.0, x[0]);
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)7.0, x[1]);
}
