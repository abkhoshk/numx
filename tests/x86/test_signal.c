...
void test_window_rect_all_ones(void)
{
    ...
    for (i = 0; i < 8; i++) TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)1.0, w[i]);
}
...
void test_window_rect_n1(void)
{
    ...
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)1.0, w[0]);
}
...
void test_window_hann_endpoints_zero(void)
{
    ...
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)0.0, w[0]);
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)0.0, w[4]);
}
...
void test_window_hann_midpoint_one(void)
{
    numx_real_t w[5];
    TEST_ASSERT_EQUAL(NUMX_OK, numx_signal_window_hann(5, w));
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)1.0, w[2]);
}
...
void test_window_hamming_endpoints(void)
{
    ...
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)0.08, w[0]);
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)0.08, w[4]);
}
...
{
    numx_real_t x[] = {(numx_real_t)1.0,(numx_real_t)1.0,(numx_real_t)1.0}, h[] = {(numx_real_t)1.0,(numx_real_t)1.0,(numx_real_t)1.0}, out[5];
    TEST_ASSERT_EQUAL(NUMX_OK, numx_signal_convolve(x, 3, h, 3, out));
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)1.0, out[0]);
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)2.0, out[1]);
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)3.0, out[2]);
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)2.0, out[3]);
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)1.0, out[4]);
}

void test_convolve_unit_impulse(void)
{
    numx_real_t x[] = {(numx_real_t)1.0,(numx_real_t)0.0,(numx_real_t)0.0}, h[] = {(numx_real_t)3.0,(numx_real_t)2.0,(numx_real_t)1.0}, out[5];
    TEST_ASSERT_EQUAL(NUMX_OK, numx_signal_convolve(x, 3, h, 3, out));
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)3.0, out[0]);
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)2.0, out[1]);
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)1.0, out[2]);
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)0.0, out[3]);
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)0.0, out[4]);
}
...
{
    numx_real_t x[] = {(numx_real_t)1.0,(numx_real_t)1.0,(numx_real_t)1.0}, out[5];
...
{
    numx_real_t x[] = {(numx_real_t)1.0,(numx_real_t)2.0}, y[] = {(numx_real_t)1.0,(numx_real_t)0.0,(numx_real_t)0.0}, out[4];
    TEST_ASSERT_EQUAL(NUMX_OK, numx_signal_correlate(x, 2, y, 3, out));
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)0.0, out[0]);
}

void test_fir_identity_tap(void)
{
    numx_real_t x[] = {(numx_real_t)1.0,(numx_real_t)2.0,(numx_real_t)3.0}, taps[] = {(numx_real_t)1.0}, out[3];
...
{
    numx_real_t x[] = {(numx_real_t)3.0,(numx_real_t)3.0,(numx_real_t)3.0,(numx_real_t)3.0,(numx_real_t)3.0};
    numx_real_t third = (numx_real_t)1.0/(numx_real_t)3.0;
    numx_real_t taps[] = {third,third,third}, out[5];
    TEST_ASSERT_EQUAL(NUMX_OK, numx_signal_fir(x, 5, taps, 3, out));
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)1.0, out[0]);
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)2.0, out[1]);
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)3.0, out[2]);
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)3.0, out[3]);
}

void test_fir_null_returns_error(void)
{
    numx_real_t x[2]={0},taps[1]={(numx_real_t)1.0},out[2]={0};
...
{
    numx_real_t x[]={(numx_real_t)1.0,(numx_real_t)2.0,(numx_real_t)3.0},b[]={(numx_real_t)1.0,(numx_real_t)0.0,(numx_real_t)0.0},a[]={(numx_real_t)0.0,(numx_real_t)0.0},out[3];
...
{
    numx_real_t x[]={(numx_real_t)1.0,(numx_real_t)2.0,(numx_real_t)3.0},b[]={(numx_real_t)2.0,(numx_real_t)0.0,(numx_real_t)0.0},a[]={(numx_real_t)0.0,(numx_real_t)0.0},out[3];
    TEST_ASSERT_EQUAL(NUMX_OK, numx_signal_iir_biquad(x,3,b,a,out));
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)2.0, out[0]);
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)4.0, out[1]);
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)6.0, out[2]);
}
...
{
    numx_real_t x[] = {(numx_real_t)0.0,(numx_real_t)1.0,(numx_real_t)0.0,(numx_real_t)2.0,(numx_real_t)0.0};
...
{
    numx_real_t x[] = {(numx_real_t)1.0,(numx_real_t)2.0,(numx_real_t)3.0,(numx_real_t)4.0,(numx_real_t)5.0};
    numx_size_t peaks[5], npeaks;
    TEST_ASSERT_EQUAL(NUMX_OK, numx_signal_peaks(x, 5, peaks, 5, &npeaks));
...
{
    numx_real_t x[] = {(numx_real_t)5.0,(numx_real_t)5.0};
...
{
    numx_real_t x[] = {(numx_real_t)1.0,(numx_real_t)2.0,(numx_real_t)3.0}, out[3];
    TEST_ASSERT_EQUAL(NUMX_OK, numx_signal_ema(x, 3, (numx_real_t)1.0, out));
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)1.0, out[0]);
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)2.0, out[1]);
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)3.0, out[2]);
}
...
{
    numx_real_t x[] = {(numx_real_t)5.0,(numx_real_t)1.0,(numx_real_t)1.0,(numx_real_t)1.0}, out[4];
    TEST_ASSERT_EQUAL(NUMX_OK, numx_signal_ema(x, 4, (numx_real_t)0.0, out));
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)5.0, out[0]);
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)5.0, out[1]);
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)5.0, out[2]);
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)5.0, out[3]);
}

void test_ema_known_sequence(void)
{
    numx_real_t x[] = {(numx_real_t)0.0,(numx_real_t)1.0,(numx_real_t)0.0,(numx_real_t)0.0}, out[4];
    TEST_ASSERT_EQUAL(NUMX_OK, numx_signal_ema(x, 4, (numx_real_t)0.5, out));
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)0.0,   out[0]);
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)0.5,   out[1]);
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)0.25,  out[2]);
    TEST_ASSERT_FLOAT_WITHIN(TOL, (numx_real_t)0.125, out[3]);
}

void test_ema_invalid_alpha_returns_error(void)
{
    numx_real_t x[2]={0}, out[2];
    TEST_ASSERT_EQUAL(NUMX_ERR_INVALID_ARG, numx_signal_ema(x, 2, -(numx_real_t)0.1, out));
    TEST_ASSERT_EQUAL(NUMX_ERR_INVALID_ARG, numx_signal_ema(x, 2,  (numx_real_t)1.1, out));
}
