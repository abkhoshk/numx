...
void test_fft(numxt_ctx_t *ctx)
{
    ...
    suite("fft / f32_dc");
    {
        ...
        chk_f (ctx, "fft_f32 dc X[0].re=8", buf[0],  (numx_real_t)8.0, (numx_real_t)1e-3);
        chk_f (ctx, "fft_f32 dc X[0].im=0", buf[1],  (numx_real_t)0.0, (numx_real_t)1e-3);
        chk_f (ctx, "fft_f32 dc X[1].re≈0", buf[2],  (numx_real_t)0.0, (numx_real_t)1e-3);
        chk_f (ctx, "fft_f32 dc X[4].re≈0", buf[8],  (numx_real_t)0.0, (numx_real_t)1e-3);
    }
    ...
    suite("fft / f32_impulse");
    {
        ...
        chk_f (ctx, "fft_f32 impulse X[0]=1", buf[0], (numx_real_t)1.0, (numx_real_t)1e-4);
        chk_f (ctx, "fft_f32 impulse X[1]=1", buf[2], (numx_real_t)1.0, (numx_real_t)1e-4);
        chk_f (ctx, "fft_f32 impulse X[2]=1", buf[4], (numx_real_t)1.0, (numx_real_t)1e-4);
        chk_f (ctx, "fft_f32 impulse X[3]=1", buf[6], (numx_real_t)1.0, (numx_real_t)1e-4);
    }
    ...
    suite("fft / f32_roundtrip");
    {
        ...
        chk_f (ctx, "roundtrip re[0]",        buf[0], orig[0], (numx_real_t)1e-3);
        chk_f (ctx, "roundtrip re[1]",        buf[2], orig[2], (numx_real_t)1e-3);
        chk_f (ctx, "roundtrip re[2]",        buf[4], orig[4], (numx_real_t)1e-3);
        chk_f (ctx, "roundtrip re[3]",        buf[6], orig[6], (numx_real_t)1e-3);
    }
    ...
    suite("fft / magnitude");
    {
        ...
        chk_f (ctx, "magnitude dc mag[0]=4",  mag[0], (numx_real_t)4.0, (numx_real_t)1e-3);
        chk_f (ctx, "magnitude dc mag[1]≈0",  mag[1], (numx_real_t)0.0, (numx_real_t)1e-3);
        chk_f (ctx, "magnitude dc mag[2]≈0",  mag[2], (numx_real_t)0.0, (numx_real_t)1e-3);
